...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-gray-950 text-gray-300 mt-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand Section */}
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xl font-bold text-white">DevBlog<span className="text-indigo-400">.</span></span>
            </div>
            <p className="text-sm text-gray-400">Seu portal de notícias e artigos</p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p>&copy; {currentYear} DevBlog. Todos os direitos reservados.</p>
            <p>Feito com <span className="text-indigo-400">♥</span> para a comunidade</p>
          </div>
        </div>
      </div>
    </footer>
